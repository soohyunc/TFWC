...
proc finish {} {
	...
	# TIME SEQUENCE PLOT
	#
	exec awk -f tcp_pkt_seq_01.awk trace/foo
	exec perl ../../ns-2.28/bin/raw2xg -s 0.01 -m 90 < trace/tcp_pkt_seq_01.temp > trace/tcp_pkt_seq_01.xg
	exec awk -f tfwc_pkt_seq_01.awk trace/foo
	exec perl ../../ns-2.28/bin/raw2xg -s 0.01 -m 90 < trace/tfwc_pkt_seq_01.temp > trace/tfwc_pkt_seq_01.xg

	exec xgraph -bg white -bb -tk -nl -m -x time -y packets -t "Sack Packet Sequence" trace/tcp_pkt_seq_01.xg &
	exec xgraph -bg white -bb -tk -nl -m -x time -y packets -t "TFWC Packet Sequence" trace/tfwc_pkt_seq_01.xg &
	...
	#
        ...
        exec xgraph -bg white -x time -y cwnd -t "TFWC CWND Dynamics" trace/tfwc_cwnd_01.xg &
        exec perl ../../../Chart-Graph-2/graph.pl -i "trace/tfwc_cwnd_01.xg" -x time -y cwnd -t "TFWC CWND Dynamics" -o graph/cwnd_dq_reverse.png -s lines &
