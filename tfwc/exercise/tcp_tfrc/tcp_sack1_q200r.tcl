...
proc finish {} {
		...
		#exec perl ../../ns-2.26/bin/raw2xg -s 0.01 -m 90 < tcp_seq04.temp > tcp_seq04.rands
                ...
                #----------------------------------------------------------/
                #exec xgraph -bb -tk -nl -m -x time -y packets -t "Sack1/TFRC (all) w/ DT (Q=200)" -geometry 1200x400 temp.rands &
                #exec xgraph -bb -tk -nl -m -x time -y packets -t "TCP Sack1 #1 w/ DT (Q=200)" -geometry 1200x400 tcp_seq01.rands &
                #exec xgraph -bb -tk -nl -m -x time -y packets -t "TCP Sack1 #2 w/ DT (Q=200)" -geometry 1200x400 tcp_seq02.rands &
                #exec xgraph -bb -tk -nl -m -x time -y packets -t "TCP Sack1 #3 w/ DT (Q=200)" -geometry 1200x400 tcp_seq03.rands &
                #exec xgraph -bb -tk -nl -m -x time -y packets -t "TCP Sack1 #4 w/ DT (Q=200)" -geometry 1200x400 tcp_seq04.rands &


                #exec xgraph -bb -tk -nl -m -x time -y packets -t "TFRC #1 w/ DT (Q=200)" -geometry 1200x400 tf_seq01.rands &
                ...
                #----------------------------------------------------------/
                #exec xgraph -P -x time -y "rate (Mb/s)" -t "Aggregated Tx rate (Sack1s and TFRCs) w/ DT (Q=200)" -geometry 1200x400 out0.tr out1.tr &
                ...
                # exec xgraph -P -x time -y "rate (Mb/s)" -t "Aggregated/Combined Thruput (Sack1s and TFRCs) w/ DT (Q=200)" -geometry 1200x400 thru.rands &
                ...
                exec xgraph -P -x time -y "rate (Mb/s)" -t "Aggregated Thruput (4Sack1+1R & 4TFRCs) w/ DT (Q=200)" -geometry 1200x400 tcp_thru.rands tf_thru.rands &

		exec perl ../../../Chart-Graph-2/graph.pl -i "tcp_thru.rands,tf_thru.rands" -x "time" -y "rate (Mb/s)" -t "Aggregated Thruput (4Sack1+1R & 4TFRC) w/ DT (Q=200)" -d 1200x400 -o ./graph/aggr_thru_sack1_q200r.png -s linespoints &
                ...
                exec xgraph -P -x time -y "Loss Rate" -t "Aggregated 4Sack1+1R/4TFRC Loss Rate w/ DT (Q=200)" -geometry 1200x400 tcp_loss.rands tf_loss.rands &

		exec perl ../../../Chart-Graph-2/graph.pl -i "tcp_loss.rands,tf_loss.rands" -x "time" -y "Loss Rate" -t "Aggregated 4Sack1+1R/4TFRC Loss Rate w/ DT (Q=200)" -d 1200x400 -o ./graph/aggr_loss_sack1_q200r.png -s linespoints &


                #exec awk -f tcp01_loss.awk out.tr
                #exec xgraph -P -x time -y "Loss Rate" -t "Sack1 #1 Loss Rate w/ DT (Q=200)" -geometry 1200x400 tcp01_temp.loss &
                #exec awk -f tcp02_loss.awk out.tr
                #exec xgraph -P -x time -y "Loss Rate" -t "Sack1 #2 Loss Rate w/ DT (Q=200)" -geometry 1200x400 tcp02_temp.loss &
                #exec awk -f tcp03_loss.awk out.tr
                #exec xgraph -P -x time -y "Loss Rate" -t "Sack1 #3 Loss Rate w/ DT (Q=200)" -geometry 1200x400 tcp03_temp.loss &
                #exec awk -f tcp04_loss.awk out.tr
                #exec xgraph -P -x time -y "Loss Rate" -t "Sack1 #4 Loss Rate w/ DT (Q=200)" -geometry 1200x400 tcp04_temp.loss &

                #exec xgraph -P -x time -y "Loss Rate" -t "Sack1r Loss Rate w/ DT (Q=200)" -geometry 1200x400 tcp01_loss.rands tcp02_loss.rands tcp03_loss.rands tcp04_loss.rands &

                #----------------------------------------------------------/
                # Instaneous Queue Size
                #----------------------------------------------------------/
                exec awk -f q_size.awk out.queue
                exec xgraph -P -x time -y "Q size" -t "Aggregated/Combined 4Sack1+1R/4TFRC Q-size w/ DT (Q=200)" -geometry 1200x400 q_size.rands &

		exec perl ../../../Chart-Graph-2/graph.pl -i "q_size.rands" -x time -y "Q size" -t "Aggregated/Combined 4Sack1+1R/4TFRC Q-size w/ DT (Q=200)" -d 1200x400 -o ./graph/all_sack1_q_size_q200r.png -s linespoints &

		exec xgraph -P -x time -y "Q size" -t "Aggregated 4Sack1+1R/4TFRC Q-size w/ DT (Q=200)" -geometry 1200x400 tcp_q.rands tf_q.rands &


		exec perl ../../../Chart-Graph-2/graph.pl -i "tcp_q.rands,tf_q.rands" -x time -y "Q size" -t "Aggregated 4Sack1+1R/4TFRC Q-size w/ DT (Q=200)" -d 1200x400 -o ./graph/aggr_q_sack1_q200r.png -s linespoints &
		...
		exec xgraph -P -x time -y RTT -t "Aggregated 4TFRC+1R RTT w/ DT (Q=200)" -geometry 1200x400 tf_rtt.rands &

		exec perl ../../../Chart-Graph-2/graph.pl -i "tf_rtt.rands" -x time -y RTT -t "Aggregated 4TFRC+1R RTT w/ DT (Q=200)" -d 1200x400 -o ./graph/aggr_tfrc_rtt_sack1_q200r.png -s linespoints &
