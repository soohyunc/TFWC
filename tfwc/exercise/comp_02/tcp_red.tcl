...
# Usage: ns tcp_red.tcl [number of TCP sources] [bottleneck queue size] [simulation time] [random seed number]
#
...
if {$argc <= 1} {
	puts "Usage: ns tcp_red.tcl \[number of TCP sources\] \[bottleneck queue size\] \[simulation time\] \[random seed number\] \> temp.tcp"
	exit
}
