...
# Usage: ns tcp_dt_reverse.tcl [number of TCP sources] [bottleneck queue size] [simulation time] [random seed number]
#
...
if {$argc <= 1} {
	puts "Usage: ns tcp_dt_reverse.tcl \[number of TCP sources\] \[bottleneck queue size\] \[simulation time\] \[random seed number\] \> temp.tcp"
	exit
}
