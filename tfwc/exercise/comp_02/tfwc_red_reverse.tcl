...
# Usage: ns tfwc_red_reverse.tcl [number of TFWC sources] [bottleneck queue size] [simulation time] [random seed number]
#
...
if {$argc <= 1} {
	puts "Usage: ns tfwc_red_reverse.tcl \[number of TFWC sources\] \[bottleneck queue size\] \[simulation time\] \[random seed number\] \> temp.tfwc"
	exit
}
