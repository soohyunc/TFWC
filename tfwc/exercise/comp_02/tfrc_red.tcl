...
# Usage: ns tfrc_red.tcl [number of TFRC sources] [bottleneck queue size] [simulation time] [random seed number]
#
...
if {$argc <= 1} {
	puts "Usage: ns tfrc_red.tcl \[number of TFRC sources\] \[bottleneck queue size\] \[simulation time\] \[random seed number\] \> temp.tfrc"
	exit
}
...
#$redq set linterm_      [expr 1.0/0.00166]
