...
proc finish {} {
	...
	exec xgraph -P -x time -y "rate (Mb/s)" -t "Aggregated Thruput (4Sack & 4TFWC) Q=5" trace/tcp_thru.xg trace/tfwc_thru.xg &
	...
	exec perl ../../../Chart-Graph-2/graph.pl -i "trace/tcp_q.xg,trace/tf_q.xg" -x time -y "Q size" -t "Aggregated Queue Size (4Sack & 4TFWC) Q=5" -o graph/aggr_q_sack_tfwc_q5.png -s linespoints &
        ...
        exec perl ../../../Chart-Graph-2/graph.pl -i "trace/tcp_loss.xg,trace/tf_loss.xg" -x time -y "Loss Rate" -t "Aggregated 4Sack/4TFWC Loss Rate, Q=5" -o graph/aggr_loss_sack_tfwc_q5.png -s linespoints &
