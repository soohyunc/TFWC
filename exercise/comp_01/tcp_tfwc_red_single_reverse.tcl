...
proc finish {} {
	...
	#
        ...
        exec xgraph -bg white -x time -y cwnd -t "TFWC CWND Dynamics" trace/tfwc_cwnd.xg &
        exec perl ../../../Chart-Graph-2/graph.pl -i "trace/tfwc_cwnd.xg" -x time -y cwnd -t "TFWC CWND Dynamics" -o graph/cwnd_red_reverse.png -s lines &
