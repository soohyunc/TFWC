...
proc finish {} {
	...
	#
        ...
        exec perl ../../../Chart-Graph-2/graph.pl -i "trace/tcp_thru.xg,trace/tfrc_thru.xg" -x "time" -y "rate (Mb/s)" -t "Thruput (Sack & TFRC)" -o graph/aggr_thru_sack_tfrc_dq_reverse.png -s lines &

	#
        # INSTANEOUS QUEUE SIZE PLOT
	#
        exec awk -f tfrc_q.awk trace/out.queue
        exec perl ../../../Chart-Graph-2/graph.pl -i "trace/tcp_q.xg,trace/tfrc_q.xg" -x time -y "Q size" -t "Queue Size (Sack & TFRC)" -o graph/aggr_q_sack_tfrc_dq_reverse.png -s lines &
	...
	#
        ...
        exec perl ../../../Chart-Graph-2/graph.pl -i "trace/tcp_loss.xg,trace/tfrc_loss.xg" -x time -y "Loss Rate" -t "Loss Rate (Sack & TFRC)" -o graph/aggr_loss_sack_tfrc_dq_reverse.png -s lines &
