...
# Usage: ns tcp_tfwc_dtq_reverse.tcl [bottleneck queue size] [simulation time] [replication number]
#
...
if {$argc < 1} {
	puts "Usage: ns tcp_tfwc_dtq_reverse.tcl \[bottleneck queue size\] \[simulation time\] \[replication number\]"
	exit
}
...
proc finish {} {
	...
	#
        ...
        exec perl ../../../Chart-Graph-2/graph.pl -i "trace/tcp_thru.xg,trace/tfwc_thru.xg" -x "time" -y "rate (Mb/s)" -t "Aggregated Thruput (Sack & TFWC)" -o graph/aggr_thru_sack_tfwc_dq_reverse.png -s lines &

	#
        # INSTANEOUS QUEUE SIZE PLOT
	#
        exec awk -f tfwc_q.awk trace/out.queue
        exec perl ../../../Chart-Graph-2/graph.pl -i "trace/tcp_q.xg,trace/tfwc_q.xg" -x time -y "Q size" -t "Aggregated Queue Size (Sack & TFWC)" -o graph/aggr_q_sack_tfwc_dq_reverse.png -s lines &
	...
	#
        ...
        exec perl ../../../Chart-Graph-2/graph.pl -i "trace/tcp_loss.xg,trace/tfwc_loss.xg" -x time -y "Loss Rate" -t "Aggregated Loss Rate (Sack & TFWC)" -o graph/aggr_loss_sack_tfwc_dq_reverse.png -s lines &
	...
	#
        ...
        exec perl ../../../Chart-Graph-2/graph.pl -i "trace/tfwc_cwnd_01.xg,trace/tfwc_cwnd_02.xg,trace/tfwc_cwnd_03.xg,trace/tfwc_cwnd_04.xg" -x time -y cwnd -t "TFWC CWND Dynamics" -o graph/cwnd_dq_reverse.png -s lines &
	...
	exec perl ../../../Chart-Graph-2/graph.pl -i "trace/tfwc_avg_int_01.xg,trace/tfwc_avg_int_02.xg,trace/tfwc_avg_int_03.xg,trace/tfwc_avg_int_04.xg" -x time -y "avg_loss_interval" -t "Avg Loss Interval" -o graph/avg_interval_dq_reverse.png -s lines &
	exec perl ../../../Chart-Graph-2/graph.pl -i "trace/tfwc_loss_in_hist_01.xg,trace/tfwc_loss_in_hist_02.xg,trace/tfwc_loss_in_hist_03.xg,trace/tfwc_loss_in_hist_04.xg" -x time -y "packet loss in avg hist" -t "Packet Loss in Avg Loss Hist" -o graph/pkt_loss_in_hist_dq_reverse.png -s points &

	exec gnuplot tfwc_dtq_avg_int_with_loss.plt &
