...
# Usage: ns tcp_tfrc_red_reverse.tcl [bottleneck queue size] [simulation time] [replication number]
#
...
if {$argc < 1} {
	puts "Usage: ns tcp_tfrc_red_reverse.tcl \[bottleneck queue size\] \[simulation time\] \[replication number\]"
	exit
}
...
proc finish {} {
	...
	#
        ...
        exec perl ../../../Chart-Graph-2/graph.pl -i "trace/tcp_thru.xg,trace/tfrc_thru.xg" -x "time" -y "rate (Mb/s)" -t "Aggregated Thruput (Sack & TFRC)" -o graph/aggr_thru_sack_tfrc_red_reverse.png -s lines &

	#
        # INSTANEOUS QUEUE SIZE PLOT
	#
        exec awk -f tfrc_q.awk trace/out.queue
        exec perl ../../../Chart-Graph-2/graph.pl -i "trace/tcp_q.xg,trace/tfrc_q.xg" -x time -y "Q size" -t "Aggregated Queue Size (Sack & TFRC)" -o graph/aggr_q_sack_tfrc_red_reverse.png -s lines &
	...
	#
        ...
        exec perl ../../../Chart-Graph-2/graph.pl -i "trace/tcp_loss.xg,trace/tfrc_loss.xg" -x time -y "Loss Rate" -t "Aggregated Loss Rate (Sack & TFRC)" -o graph/aggr_loss_sack_tfrc_red_reverse.png -s lines &
	...
	#
        ...
        #exec perl ../../../Chart-Graph-2/graph.pl -i "trace/tfrc_cwnd.xg" -x time -y cwnd -t "TFRC CWND Dynamics" -o graph/cwnd_red_reverse.png -s lines &
