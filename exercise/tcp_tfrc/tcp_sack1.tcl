...
proc finish {} {
		...
		#exec perl ../../ns-2.26/bin/raw2xg -s 0.01 -m 90 < tcp_seq04.temp > tcp_seq04.rands
                ...
                # exec xgraph -P -x time -y "rate (Mb/s)" -t "Aggregated/Combined Thruput (4Sack1 & 4TFRC) w/ DT (Q=Default)" -geometry 1200x400 temp.thru &
                ...
                exec xgraph -P -x time -y "rate (Mb/s)" -t "Aggregated Thruput (4Sack1 & 4TFRC) w/ DT (Q=Default)" -geometry 1200x400 tcp_thru.rands tf_thru.rands &

		exec perl ../../../Chart-Graph-2/graph.pl -i "tcp_thru.rands,tf_thru.rands" -x "time" -y "rate (Mb/s)" -t "Aggregated Thruput (4Sack1 & 4TFRC) w/ DT (Q=default)" -d 1200x400 -o ./graph/aggr_thru_sack1.png -s linespoints & 
		...
		exec xgraph -P -x time -y "Loss Rate" -t "Aggregated 4Sack1/4TFRC Loss Rate w/ DT (Q=Default)" -geometry 1200x400 tcp_loss.rands tf_loss.rands &

		exec perl ../../../Chart-Graph-2/graph.pl -i "tcp_loss.rands,tf_loss.rands" -x "time" -y "Loss Rate" -t "Aggregated 4Sack1/4TFRC Loss Rate w/ DT (Q=default)" -d 1200x400 -o ./graph/aggr_loss_sack1.png -s linespoints &
		...
		#exec xgraph -P -x time -y "Loss Rate" -t "Sack1 Loss Rate w/ DT (Q=Default)" -geometry 1200x400 tcp01_loss.rands tcp02_loss.rands tcp03_loss.rands tcp04_loss.rands &
                ...
                exec xgraph -P -x time -y "Q size" -t "Aggregated/Combined 4Sack1/4TFRC Q-size w/ DT (Q=Default)" -geometry 1200x400 q_size.rands &

		exec perl ../../../Chart-Graph-2/graph.pl -i "q_size.rands" -x time -y "Q size" -t "Aggregated/Combined 4Sack1/4TFRC Q-size w/ DT (Q=Default)" -d 1200x400 -o ./graph/all_sack1_q_size_default.png -s linespoints &

                exec xgraph -P -x time -y "Q size" -t "Aggregated 4Sack1/4TFRC Q-size w/ DT (Q=Default)" -geometry 1200x400 tcp_q.rands tf_q.rands &

		exec perl ../../../Chart-Graph-2/graph.pl -i "tcp_q.rands,tf_q.rands" -x time -y "Q size" -t "Aggregated 4Sack1/4TFRC Q-size w/ DT (Q=Default)" -d 1200x400 -o ./graph/aggr_q_sack1.png -s linespoints &
		...
		exec perl ../../../Chart-Graph-2/graph.pl -i "tf_rtt.rands" -x time -y RTT -t "Aggregated 4TFRC RTT w/ DT (Q=Default)" -d 1200x400 -o ./graph/aggr_tfrc_rtt_sack1_q_default.png -s linespoints &
