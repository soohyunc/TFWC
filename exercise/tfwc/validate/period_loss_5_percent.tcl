...
proc finish {} {
	...
	#exec xgraph -P -x time -y rate -t "TFWC Test" ./trace/thru.xg &
        ...
        exec grep HISTORY temp.tfwc > ./trace/tfwc_periodic(0.05).HISTORY &
        exec grep avg_interval temp.tfwc > ./trace/tfwc_periodic(0.05).AvgInt &
        exec grep cwnd_ temp.tfwc > ./trace/tfwc_periodic(0.05).cwnd &
	...
	exec perl ../../../../Chart-Graph-2/graph.pl -i "./trace/tfwc_cwnd.xg" -x "time" -y "cwnd" -t "TFWC CWND Dynamics w/ (5% periodic)" -o ./graph/tfwc_cwnd_5p_periodic.png -s linespoints &
