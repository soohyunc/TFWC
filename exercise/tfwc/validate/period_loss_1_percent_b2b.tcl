...
proc finish {} {
	...
	exec grep HISTORY temp.tfwc > ./trace/tfwc_periodic(0.01)_b2b.HISTORY &
	exec grep avg_interval temp.tfwc > ./trace/tfwc_periodic(0.01)_b2b.AvgInt &
	exec grep cwnd_ temp.tfwc > ./trace/tfwc_periodic(0.01)_b2b.cwnd &

	
	exec xgraph -m -x time -y cwnd -t "TFWC CWND Dynamics" ./trace/tfwc_cwnd.xg &
	exec perl ../../../../Chart-Graph-2/graph.pl -i "./trace/tfwc_cwnd.xg" -x "time" -y "cwnd" -t "TFWC CWND Dynamics w/ (1% periodic_b2b)" -o ./graph/tfwc_cwnd_1p_periodic_b2b.png -s linespoints &
