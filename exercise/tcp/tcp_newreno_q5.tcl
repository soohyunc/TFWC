# TCP NewReno w/ DropTail, queue=5
#
...
proc finish {} {
		...
		exec xgraph -bb -tk -nl -m -x time -y packets -t "TCP NewReno w/ DT Q=5" temp.rands &
		exec xgraph -P -x time -y "rate (Mb/s)" -t "Tx rate for TCP NewReno w/ DT Q=5" out0.tr &

		# thruput calculation
		exec awk -f thru.awk out.queue
		exec xgraph -P -x time -y "rate (Mb/s)" -t "Thruput for TCP NewReno w/ DT Q=5" temp.thru &
