...
proc finish {} {
		...
		exec perl ../../ns-2.26/bin/raw2xg -m 90 < foo > temp.rands
		exec xgraph -bb -tk -nl -m -x time -y packets -t "TCP Reno w/ DT Q=5" temp.rands &
		exec xgraph -P -x time -y "rate (Mb/s)" -t "Tx rate for TCP Reno w/ DT Q=5" out0.tr &

		# thruput calculation
		exec awk -f thru.awk out.queue
		exec xgraph -P -x time -y "rate (Mb/s)" -t "Thruput for TCP Reno w/ DT Q=5" temp.thru &
