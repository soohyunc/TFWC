# TCP Tahoe w/ queue size from n2 to n3 is 15 
#
...
proc finish {} {
		...
		exec xgraph -bb -tk -nl -m -x time -y packets -t "TCP Tahoe w/ DT Q=15" temp.rands &
		exec xgraph -P -x time -y "rate (Mb/s)" -t "Tx rate for TCP Tahoe w/ DT Q=15" out0.tr &

		# thruput calculation
		exec awk -f thru.awk out.queue
		exec xgraph -P -x time -y "rate (Mb/s)" -t "Thruput for TCP Tahoe w/ DT Q=15" temp.thru &
