...
# Usage: ns tfwc_red.tcl [number of TFWC sources] [bottleneck queue size] [simulation time] [random seed number]
#
# Author: Soo-Hyun Choi (UCL Computer Science)
# E-mail: s.choi@cs.ucl.ac.uk
#
# $Header: /home/narwhal/u0/soohyunc/CVS_SERV/TFWC/exercise/comp_02/tfwc_red.tcl,v 1.6 2006/01/19 04:15:54 soohyunc Exp $

if {$argc <= 1} {
	puts "Usage: ns tfwc_red.tcl \[number of TFWC sources\] \[bottleneck queue size\] \[simulation time\] \[random seed number\] \> temp.tfwc"
	exit
}
...
#$redq set q_weight_ 0.02
$redq set linterm_ 5000
